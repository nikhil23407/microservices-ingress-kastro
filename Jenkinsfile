pipeline {
    ...
    environment {
        DOCKER_HUB_REPO = 'nikhil23407/techsolutions-app'
        K8S_CLUSTER_NAME = ' nikhil-cluster'
    ...
    stages {
        ...
        stage('Deploy to Kubernetes') {
            steps {
                ...
                script {
                    withCredentials([[$class: 'AmazonWebServicesCredentialsBinding', credentialsId: 'aws-secret']]) {
                        sh "sed -i 's|nikhil23407/techsolutions-app:latest|nikhil23407/techsolutions-app:${env.IMAGE_TAG}|g' k8s/deployment.yaml"
